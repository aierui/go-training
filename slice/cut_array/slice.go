...
func main() {
	...
	/*
		...
		s9(4): [2 3 4 1 2 3 4] (len: 7, cap: 12) // 发生了扩容
		s9(5): [2 3 4 1 2 3 4 5] (len: 8, cap: 12)
		a1: [1 2 3 4 1 2 3] (len: 7, cap: 7) // 一个切片的底层数组永远不会被替换 为什么？虽然在扩容的时候 Go 语言一定会生成新的底层数组，但是它也同时生成了新的切片。
